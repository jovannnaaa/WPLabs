...
public class ChefServiceImpl implements ChefService {
    ...
    @Override
    public Chef create(Long id, List<Dish> dishes, String bio, String firstName, String lastName, ChefGender gender) {
        Chef c = new Chef(id, dishes, bio, firstName, lastName, gender);
